        ...
        <form name="dtr" action="" >
            <div id="dtrone">
              <table  style="position:absolute;top:250px" bgcolor="#E0ECF8"  cellpadding="5" cellspacing="5" width="350px">
                       <tr><th colspan="2"><h2><u> Update DTR</u></h2></th></tr>
                  		<tr>
                      <td>Zone name:</td>
                      <td>
		...
		<tr>
		 ...
		 <tr>
                  ...
                  <tr>
                      <td>select DTR:</td>
                      <td>
                          <select name="dtr" id="dtrId" style="width:150px;height:20px;font-size:12px;font-family:verdana;" onchange="oldDtr();" >
                    ...
                    <div id="dtrtwo">
                       <table bgcolor="#E0ECF8" width="350px" style="position:absolute;top:250px;left:600px">
                           <tr>
                               <td>DTR Id:</td>
                               <td><input type="text" id="newdtrId" readonly></td>
                           </tr>
                           <tr>
                               <td>DTR Name:</td>
                               <td><input type="text" id="dtrName"></td>
                           </tr>
                           <tr>
                      <td>DTR Capacity:</td>
                      <td><input type="text" name="dtrcapacity" id="newCapacity"/></td>
                  </tr>
                           <tr>
                               <td>Select Feeder:</td>
                               <td>
                                    <select name="newfeeder" id="newfeederId" style="width:150px;height:20px;font-size:12px;font-family:verdana;">
                         ...
                         <option value="-1">Select Feeder</option>
                           ...
                           <tr>
                                 <td></td>
                                 <td><input type="button" onclick=" newDtr()" value="update"></td>
                             </tr>
