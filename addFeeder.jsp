...
<form name="feeder" action="" >
    <table align="center" bgcolor="#E0ECF8" cellpadding="5" cellspacing="5">
        <tr><th colspan="2"><h2><u> Add Feeder</u></h2></th></tr>
        <tr>
            <td>Zone name:</td>
            <td>
        ...
        <tr>
            ...
            <td>
                <select name="dcu" id="dcuId" style="width:150px;height:20px;font-size:12px;font-family:verdana;">
        ...
        <tr>
            <td>Feeder name:</td>
            <td><input type="text" name="Feeder" id="feederId"/></td>
        </tr>
        <tr>
            <td>Classic voltage:</td>
            <td><input type="text" name="Cvoltage" id="Cvoltage" value="11"/></td>
        </tr>
        <tr>
            <td></td>
            <td><input type="button" value="add " onclick="insertFeeder()"/></td>
        </tr>
