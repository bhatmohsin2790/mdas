...
function showTownsStateChanged()
{
 if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
 {
	...
	for(var j=document.getElementById("townd").options.length-1;j>=0;j--)
                      {
...
<table border="0" style="font-size:12px;">
    ...
    <tr>
        ...
        <td>
            <select name="townn" id ="townId" style="width:150px;height:20px;font-size:12px;font-family:verdana;"
    ...
    <tr>
        <td>Select Date:</td></tr>
    <tr>
        <td><input type="text" readonly="true" size="10" name="startingDate" id="startingDate"/>
		      <a href="javascript:show_calendar('select.startingDate')"> <img src="images/cal1.gif" id="sdate"  width=24 height=22 border=0/></a>
	              </td>
    </tr>
</table>
</form>