...
<form name="ss"  action="addSubStationData.jsp">
    <table bgcolor="#E0ECF8" cellpadding="5" cellspacing="5" >
        <tr><th colspan="2"><h2><u> Add SubStation</u></h2></th></tr>
        <tr>
            <td >Zone name:</td>
            <td>
        ...
        <tr>
            ...
            <td>
                <select name="subdivisionname" id="subdivisionId" style="width:150px;height:20px;font-size:12px;font-family:verdana;" onchange="showTowns(this.value);">
         ...
         <tr>
            ...
            <td><input type="text" name="substation" id="ssId"/></td>
        </tr>
        <tr>
            <td></td>
            <td><input type="button" value="add " onclick="insertSubStation()"/></td>
        </tr>
    </table>
</form>
