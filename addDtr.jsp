    ...
    <body>
        <form name="dtr" action=""  >
            <table align="center" bgcolor="#E0ECF8"  cellpadding="5" cellspacing="5">
                <tr><th colspan="2"><h2><u> Add DTR</u></h2></th></tr>
                <tr>
                    <td>Zone name:</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="feeder" id="feederId" style="width:150px;height:20px;font-size:12px;font-family:verdana;">
                ...
                <tr>
                    <td>DTR name:</td>
                    <td><input type="text" name="dtrname" id="dtrId"/></td>
                </tr>
                <tr>
                    <td>DTR Capacity:</td>
                    <td><input type="text" name="dtrcapacity" id="dtrCapacity" value="100"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input type="button" value="add "  onclick="insertDtr()"/></td>
                </tr>
