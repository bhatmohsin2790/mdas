...
//out.println("dcu==>"+dcu_id);
    ...
    <%
    pstmt = con.prepareStatement("select * from (select DI_NAME,DI_VALUE,RTU_ID from rtu_di_data where rtu_id=? and DI_DATE=? and TIME=? order by sno) tab1,(select Name1,RTU_ID,Description from digital_input_details where rtu_id=? order by srlno) tab2 where tab1.DI_NAME=tab2.Name1");
    pstmt.setString(1, dcu_id);
