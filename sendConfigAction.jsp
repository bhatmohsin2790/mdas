...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%@page import="in.amitech.params.SendConfigurationParams"%>
            ...
            <tr>
                ...
                <td height="380px"width=98% style="background:url(images/bg-content-center.png) repeat-x;padding-left:10px;padding-right:10px;padding-bottom:10px;padding-top:10px;" valign="top">
                    ...
                    <%
                                ...
                                SendConfigurationParams mcp = null;
                                ...
                                try {
                                    ...
                                    for (int i = 0; i < meterIds.length; i++) {
                                        ...
                                        mcp = new SendConfigurationParams();
                                        ...
                                        if (mrs.next()) {
                                            //old style
                                            //mobileNumber = mrs.getString("mobileno");
                                    ...
                                    if (reqStatus && uniqStatus) {
                                        ...
                                        if (l.isEmpty()) {
                                            ...
                                            Map m = mdas.sendConfigurationSMS(l);
