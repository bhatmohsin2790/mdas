    ...
    <body>
        <form name="feeder" action="" >
              <table align="center" bgcolor="#E0ECF8" cellpadding="5" cellspacing="5">
                    <tr><th colspan="2"><h2><u> Add DCU_Mapping  </u></h2></th></tr>
          ...
          <%
                  ...
                  <tr>
                      <td align="left">Select Dcu : </td>
                       ...
                       <td>
                           <select name="dcu" id="dcuId" style="width:150px;height:20px;font-size:12px;font-family:verdana;" onchange="showModems();">
                  ...
                  <tr>
                      <td></td>
                      <td><input type="button" value="add " onclick="insertDCUMap()"/></td>
                  </tr>
              </table>
          </form>
    </body>
