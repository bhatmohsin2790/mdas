           ...
           feederName=request.getParameter("feederName").trim();
            ...
            ssSelect=request.getParameter("ssSelect").trim();
                ...
                if ( feederName.equals("")) {
                    ...
                    sql = "update feeder set feedername='"+ feederName+"',classvoltage='"+classVoltage+"',dcuid="+ dcuSelect+",substationid="+ssSelect+"  where feederid="+feederId+"";                    if (st.executeUpdate(sql) > 0) {
