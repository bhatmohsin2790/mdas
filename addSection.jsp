...
<form name="section"  >
    <table align="center" bgcolor="#E0ECF5" cellpadding="5" cellspacing="5">
        <tr><th colspan="2"><h2><u> Add Section</u></h2></th></tr>
        <tr>
            <td>Zone name:</td>
            <td>
        ...
        <tr>
            ...
            <td>
                <select name="subdivisionname" id="subdivisionId" style="width:150px;height:20px;font-size:12px;font-family:verdana;">
        ...
        <tr>
            <td>Section name:</td>
            <td><input type="text" name="section" id="sectionId"/></td>
        </tr>
        <tr>
            <td></td>
            <td><input type="button" value="add " onclick="insertSection();"/></td>
        </tr>
