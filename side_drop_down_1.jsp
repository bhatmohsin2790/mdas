...
{
    alert("reached here....side drop down_1.jsp.....!"+emp_value);
    //------------Removing the previous values---------------------
//	for(var j=document.forms[0].division.options.length-1;j>=0;j--){
//		document.forms[0].division.remove(j);
//		}
...
{
    //alert("Length of selection box is ----------->"+opt.toString().length);
    //alert("Selected Value is----------->"+opt);
...
{
 //alert("State DTR Changed");
 if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
 {

    var showdata = xmlHttp.responseText;
    //alert("State DTR Changed"+showdata);
