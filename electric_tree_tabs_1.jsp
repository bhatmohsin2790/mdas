    ...
    if(data_type==1)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="addSubStation.jsp";
                                             xmlHttp.onreadystatechange=addSubStationData;
             ...
             if(data_type==2)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="deleteSubStation.jsp";
                                             xmlHttp.onreadystatechange=deleteSubStationData;
             ...
             if(data_type==3)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="updateSubStation.jsp";
                                             xmlHttp.onreadystatechange=updateSubStationData;
...

        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="viewSubStation.jsp";
                                             xmlHttp.onreadystatechange=viewSubStationData;
    ...
    if(data_type==1)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="addFeeder.jsp";
                                             xmlHttp.onreadystatechange=addFeederData;
             ...
             if(data_type==2)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="deleteFeeder.jsp";
                                             xmlHttp.onreadystatechange=deleteFeederData;
             ...
             if(data_type==3)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="updateFeeder.jsp";
                                             xmlHttp.onreadystatechange=updateFeederData;
...

        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="viewFeeder.jsp";
                                             xmlHttp.onreadystatechange=viewFeederData;
     ...
     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="viewDtr.jsp?start="+start;
                                             xmlHttp.onreadystatechange=viewDtrData;
         ...
         if(data_type==1)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="addDtr.jsp";
                                             xmlHttp.onreadystatechange=addDtrData;
            ...
            if(data_type==2)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="deleteDtr.jsp";
                                             xmlHttp.onreadystatechange=deleteDtrData;
            ...
            if(data_type==3)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="updateDtr.jsp";
                                             xmlHttp.onreadystatechange=updateDtrData;
            ...
            if(data_type==1)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="addHT.jsp";
                                             xmlHttp.onreadystatechange=addHTData;
             ...
             if(data_type==2)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="deleteHT.jsp";
                                             xmlHttp.onreadystatechange=deleteHTData;
             ...
             if(data_type==3)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="updateHT.jsp";
                                             xmlHttp.onreadystatechange=updateHTData;
...

        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="viewHT.jsp";
                                             xmlHttp.onreadystatechange=viewHTData;
            ...
            if(data_type==1)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="addDCU.jsp";
                                             xmlHttp.onreadystatechange=addDCUData;
             ...
             if(data_type==2)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="deleteDCU.jsp";
                                             xmlHttp.onreadystatechange=deleteDCUData;
             ...
             if(data_type==3)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="updateDCU.jsp";
                                             xmlHttp.onreadystatechange=updateDCUData;
             ...
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         alert ("Browser does not support HTTP Request");
                                            ...
                                            var url="viewDCU.jsp";
                                             xmlHttp.onreadystatechange=viewDCUData;
            ...
            if(data_type==1)
        {
             xmlHttp=GetXmlHttpObject();
                                     if (xmlHttp==null)
                                     {
                                         ...
                                         var url="addDcdMap.jsp";
                                             xmlHttp.onreadystatechange=addDCUMapData;
...
<script type="text/javascript">
    function insertSubStation(){
       ...
       sectionSel=document.getElementById("sectionId");

      section=sectionSel.options[sectionSel.selectedIndex].value;
      ...
      //alert(section);
       ...
       //alert(ss);
        ...
        var url="master_data_actions/addSubStationAction.jsp?sectionId="+escape(section)+"&ssname="+escape(ss);
    ...
    function oldFeeder()
{
   ...
   sectSel=document.getElementById("sectionId");
...
function oldFeederAction()
{
        ...
        if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
 {
   ...
   //alert("show"+showdata);
	...
	//----- Values inserting into Combo Box Dynamicaly------
		for(var j=document.forms[0].newsection.options.length-1;j>=0;j--)
                      {
				document.forms[0].newsection.remove(j);
			}

                           var combo = document.getElementById("newsection");
    ...
    function newSs()
    {
       ...
       // alert("new name is "+newName);
        ...
        var newSname=newSection.options[newSection.selectedIndex].value;
        ...
        var url="master_data_actions/updateSubstationAction.jsp?ssId="+escape(ssId)+"&ssName="+escape(newName)+"&sName="+escape(newSname);
        //alert("url is "+url);
    ...
    function newDtr()
   {
    ...
    function oldDcu()
    {
       ...
       document.getElementById("dcuid").value=dcuId;
        ...
        ssSel=document.getElementById("sectionId");
          var ssid=ssSel.options[ssSel.selectedIndex].value;
          xmlHttp=GetXmlHttpObject();
        ...
        var url="getSubstations.jsp?emp_id="+escape(ssid);
       // alert("url is "+url);
