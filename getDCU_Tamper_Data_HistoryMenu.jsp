...
try
{
    ...
    <a href="javascript:show_calendar('dcuTamper.fromdate')"> <img src="images/cal1.gif" id="sdate"  width=24 height=22 border=0 /></a>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="todate" size="10" />
                     <a href="javascript:show_calendar('dcuTamper.todate')"> <img src="images/cal1.gif" id="edate"  width=24 height=22 border=0 /></a>
                </td>
                <td><input type="button" value="Get Data" onclick="getHistory_Tamper()" /></td>
            </tr>
        </table></div>
