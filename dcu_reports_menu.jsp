          ...
          //document.getElementById("eDate").value="";
                ...
                if(tabeId=="cnt-31")
                {
                   // var ssId=document.getElementById("substation").value;            
					...
					//getDCUConfig_Screen(ssId);
					//alert("in DCU Config"); */
                }
                if(tabeId=="cnt-32")
                {
                    document.getElementsByName("dcu_opt")[15].checked = true;
                    getDCUData();
                }
...
<div class="tab-box1" id="dcu">
    ...
    <a href="javascript:;" class="tabLink1 " id="cnt-30">Send On Demand</a>
   <!--  <a href="javascript:;" class="tabLink1 " id="cnt-32">On Demand Reports</a>
...
<div class="tabcontent1 paddingAll hide" id="cnt-31-1">
   <!-- <div class="button_style" style="visibility:hidden;"><input type="radio" name="dcu_opt"  id="dcu_opt" value="15" onclick="getDCUData()">On Demand for Data&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
	...
	<%@include file="DCU_Config_Screen.jsp"%>
</div>
<div class="tabcontent1 paddingAll hide" id="cnt-32-1">
<div class="button_style"><input type="radio" name="dcu_opt"  id="dcu_opt" value="16" onclick="getDCUData()">Latest Records&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
</div>
