...
<html xmlns="http://www.w3.org/1999/xhtml" height="100%">
    ...
    <head>
        ...
        <script type="text/javascript" language="jscript">
            ...
            function showAlerts()
            {
                ...
                if(substationId=="0"){
                    alert("plz select the hierarchy upto  substation");
                    return;
                }
            ...
            function  Alerts(start)
            {
                ...
                var url="alertReport.jsp?meterId="+escape(meter)+"&date="+escape(date)+"&endDate="+escape(endDate)+
                    "&values="+escape(values)+"&start="+start+"&location="+escape(meterLocation)+"&substationId="+escape(substationId);
                //  alert(url);
                xmlHttp.onreadystatechange=showAlertsAction;
    ...
    <body onload='getCheckBoxes();'>
                        ...
                        <form name="alert_form">
                            <table  cellpadding="5" cellspacing="5">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Get Report" onclick="showAlerts();"/></td>
        ...
        <div id="dcucheckBoxes" style="visibility:hidden">
            <table><tr>
                    <td ><input type="radio" id="a5" name="alert" value="5" onclick="deselect(this);"/>&nbsp;&nbsp;&nbsp;CRC Failed</td>                      
                    <td id="dcuPowerFail"><input type="radio" id="a6" name="alert" value="6" onclick="deselect(this);"/>&nbsp;&nbsp;&nbsp;DCU Power Fail</td>
                    <td ><input type="radio" id="a7" name="alert" value="7" onclick="deselect(this);"/>&nbsp;&nbsp;&nbsp;Invalid Meter Data</td>
                    <td ><input type="radio" id="a8" name="alert" value="8" onclick="deselect(this);"/>&nbsp;&nbsp;&nbsp;Zero N/W</td>
                    <td ><input type="radio" id="a9" name="alert" value="9" onclick="deselect(this);"/>&nbsp;&nbsp;&nbsp;Not Communicating</td>

                </tr></table>
        </div>
        <div id="metercheckBoxes" style="visibility: hidden;">
            <table>
                <tr><td><input type="checkbox" onclick="selectall(this);" name="allalert" id="all"/>&nbsp;&nbsp;&nbsp;Select All</td></tr>
                <tr>
