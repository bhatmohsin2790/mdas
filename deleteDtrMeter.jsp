    ...
    <body>
        <form action="" name="feeder">
            <table align="center" bgcolor="#E0ECF5" cellpadding="5" cellspacing="5">
                <tr> <th colspan="2"><h2><u>Delete DTR-meter Mapping</u></h2></th></tr>
                <tr>
        ...
        con.close();
                ...
                <tr>
                    <td>select DTR:</td>
                    <td>
                        <select name="dtr" id="dtrId" style="width:150px;height:20px;font-size:12px;font-family:verdana;" onchange="showdtrMeter(this.value);">
                ...
                <tr>
                    <td></td>
                    <td> <input type="button"  onclick="deleteDtrMeter()"value="Delete" ></td></tr></table>
        </form>
    </body>
</html>