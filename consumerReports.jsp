  ...
  $(document).ready(function() {
    $(".tabLink").each(function(){
      $(this).click(function(){
        ...
        return false;
            ...
            {
                    alert("reached here....consumerReports.jsp.....!"+emp_value);
                //------------Removing the previous values---------------------
                //	for(var j=document.forms[0].division.options.length-1;j>=0;j--){
                //		document.forms[0].division.remove(j);
                //		}
            ...
            function state_DTR_Changed()
            {
                ...
                if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
                {
                    ...
                    else if(strar.length>1)
                    {
                        ...
                        {
                            var option = document.createElement("option");
                            option.text = strar[i].trim().substring(strar[i].indexOf("_")+1);//textb.value;
                ...
                function showHT(emp_value,i)
            {
                ...
                if(emp_value!="-1")
                {
                    ...
                    xmlHttp.onreadystatechange=state_HT_Changed;
                    xmlHttp.open("GET",url,true);
                    xmlHttp.send(null);

                }else
                {
                    alert("Please Select HT ");
                }
            }//showDivisions

            function state_HT_Changed()
            {
                ...
                if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
                {
                    ...
                    else if(strar.length>1)
                    {
                        ...
                        var combo = document.getElementById("ht");
                        for(var i=0;i<strar.length-1;i++)
                        {
                            var option = document.createElement("option");
                            option.text = strar[i].trim().substring(strar[i].indexOf("_")+1);//textb.value;
    ...
    <body>
        ...
        <table width=100% border=0 cellpadding=0 cellspacing=0 style="background:url(images/body.png) repeat-x;">
            ...
            <tr>
                <td width=220px valign="top" style="padding-left:10px;padding-top:10px;background:url(images/side.jpg) repeat-x;background-color:#EDF5FA;" align="center">
                   <table border="0" cellpadding=0 cellspacing=0 style="font-family:Verdana,Arial,Helvetica,sans-serif;font-size:12px;">
                    ...
                    <br></br>
                    <br/>
                    <%@ include file="side_consumer_reports.jsp"%>
                ...
                <td width=83% style="background:url(images/bg-content-center.png) repeat-x;padding-left:10px;padding-right:10px;padding-bottom:10px;padding-top:10px;" valign="top">
                    ...
                    <div id="submenu" style="float:left;width: 100%;">
                        <%@ include file="reports_menu.jsp"%>
                    </div>
                        <br/>
                    <!--<div class="tab-box" >
    <a href="javascript:;" class="tabLink activeLink" id="cont-1">Instantaneous Paramaters</a>
    <a href="javascript:;" class="tabLink " id="cont-2">Load Survey</a>
    <a href="javascript:;" class="tabLink " id="cont-3">Tamper Data</a>
    <a href="javascript:;" class="tabLink " id="cont-4">Energies</a>
    <a href="javascript:;" class="tabLink " id="cont-5">Transaction</a>
