...
<table bgcolor="#87CEEB">
    ...
    <%
        try {
            ...
            String query = "select m.meter_serial_no,ht.consumername from ht_consumer ht,meter m ,feeder f,substation s ,town t where m.htconsumerid=ht.consumerid and ht.feederid=f.feederid and f.substationid=s.substationid and s.townid=t.townid and t.townid=" + townId + " order by ht.consumername";
