...
<tr>
	...
	<td width=98% style="background:url(images/bg-content-center.png) repeat-x;padding-left:10px;padding-right:10px;padding-bottom:10px;padding-top:7px;" valign="top">
            ...
            <p><b>MODEM STATUS REPORTS </b></p><br></br>
...
<table ><tr><td valign="top">
		...
		<a href="javascript:show_calendar('sform.startingDate')"> <img src="images/cal.gif" id="sdate"  width=24 height=22 border=0/></a>
	    </td>
        </tr>
        <tr>
           <td>Ending Date:
               <input type="text" readonly="true" size="10" name="endingDate" id="endingDate"/>
		<a href="javascript:show_calendar('sform.endingDate')"> <img src="images/cal.gif" id="edate"  width=24 height=22 border=0/></a>
	    </td>
        </tr>
        <tr>
              <td align="center">
