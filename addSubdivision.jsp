...
<form name="subdivision"  action="addSubdivisionData.jsp">
    <table align="center" bgcolor="#E0ECF8"  cellpadding="5" cellspacing="5">
        <tr><th colspan="2"><h2><u> Add SubDivision</u></h2></th></tr>
        <tr>
            <td>Zone name:</td>
            <td>
                <select name="zone" id="division" style="width:150px;height:20px;font-size:12px;font-family:verdana;" onchange="showCircles(this.value);">
        ...
        <tr>
            ...
            <td><input type="text" name="subdivision" id="subdivisionname"/></td>
        </tr>
        <tr>
            <td></td>
            <td><input type="button" value="add " onclick="insertSubDivision();"/></td>
        </tr>
