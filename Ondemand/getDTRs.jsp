...
try{
 ...
 Connection con = new DBUtil().getConnection();
  String query="select m.meter_serial_no,d.dtrname from dtr d,meter m,feeder f,substation s where d.feederid=f.feederid and f.substationid=s.substationid and s.substationid="+ssID+" and m.dtrid=d.dtrid order by d.dtrname";
