...
<form name="meterReportsForm" action="javascript:void(0)">
    <table border="0" width="150px" style="padding-top: 0em; padding-bottom: 0.0em;display:none;">
        <tr>
            <td align="left" style="line-height: 18px;">
                <table border="0">
                    <tr>
                        ...
                        <td> Feeder</td>
                        <td><input type="radio" name="r1" value="dtr"  onclick="getHirarchy(this.value);"/></td>
                        <td> DTR</td>
                    </tr>
                </table>
            </td>
    ...
    <div id="getHirarchy">
        ...
        <td align="left">
            ...
            <tr>
                <td align="left">
                    <select name="dtr" id="dtr" style="width:150px;font-size:12px;font-family:verdana;" size="6" onChange="sendMeterId();">
                    </select>
                </td>
            </tr>
