...
<%
    try{
        ...
        String data="";
            ...
            if(option==0)
            {
                pstmt = con.prepareStatement("select m.meterid,m.meter_serial_no,d.dtrid,d.dtrname,d.feederid,d.mobileno from meter m,dtr d where m.meterid = d.meter_id and m.meterid in (select meterid from dtr where feederid='"+feederid+"')");
                rs = pstmt.executeQuery();
                while(rs.next())
