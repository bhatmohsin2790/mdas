...
<table width="100%" border="0" >
    <tr bgcolor="#56a5ec">
        <td colspan="8" align="center" class="head1">
            METER INFORMATION
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="120px" bgcolor="#e0ecf8" style="font-weight:bold;">METER CTR<BR/>METER PTR</td><td class="meter_info_td2"><%=rs.getString(9)+"<BR/>"+rs.getString(10)%></td> 
        <td width="120px" bgcolor="#e0ecf8" style="font-weight:bold;">Adopted CTR<BR/>Adopted PTR</td><td class="meter_info_td2"><%=rs.getString(11)+"<BR/>"+rs.getString(12)%></td> 
        <td width="120px" bgcolor="#e0ecf8" style="font-weight:bold;">MF</td><td class="meter_info_td2"><%=rs.getString(13)%></td> 
        <td width="120px" bgcolor="#e0ecf8" style="font-weight:bold;">Location Code<BR/>Consumer Id</td><td class="meter_info_td2"><%=rs.getString(14)==null?" ":rs.getString(14)+"<BR/>"+(rs.getString(15)==null?" ":rs.getString(15))%></td> 
    </tr>
</table>
...
<table width="100%" border="0" >
    ...
    <tr>
        <td width="120px" bgcolor="#e0ecf8" style="font-weight:bold;">METER CTR<BR/>METER PTR</td><td class="meter_info_td2"><%=rs.getString(10)+"<BR/>"+rs.getString(11)%></td> 
        <td width="120px" bgcolor="#e0ecf8" style="font-weight:bold;">Adopted CTR<BR/>Adopted PTR</td><td class="meter_info_td2"><%=rs.getString(12)+"<BR/>"+rs.getString(13)%></td> 
        <td width="120px" bgcolor="#e0ecf8" style="font-weight:bold;">MF</td><td class="meter_info_td2"><%=rs.getString(14)%></td> 
         <td width="120px" bgcolor="#e0ecf8" style="font-weight:bold;">Location Code<BR/>Consumer Id</td><td class="meter_info_td2"><%=rs.getString(15)==null?" ":rs.getString(15)+"<BR/>"+(rs.getString(16)==null?" ":rs.getString(16))%></td> 
    </tr>
</table>
